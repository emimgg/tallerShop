            ...
            <div className="mb-4">
              ...
              <div className="space-y-3">
                {items.map((item, index) => (
                  <div key={index} className="flex flex-col md:flex-row gap-2 md:gap-3 md:items-center p-3 md:p-0 bg-gray-50 md:bg-transparent rounded-lg md:rounded-none">
                    <select
          ...
          <tbody>
            {quotes.map(quote => (
              ...
              >
                ...
                <td className="px-6 py-4 font-semibold text-gray-800">Gs. {quote.total.toFixed(0)}</td>
                <td className="px-6 py-4">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    quote.status === 'pendiente'
                      ? 'bg-yellow-100 text-yellow-600'
                      : quote.status === 'finiquitado'
        ...
        {quotes.map(quote => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold text-gray-800">Gs. {quote.total.toFixed(0)}</p>
            </div>
          </div>
        ))}
        {quotes.length === 0 && (
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full md:w-96 bg-white h-full shadow-xl flex flex-col z-10">
            ...
            <div className="flex-1 p-6 overflow-auto space-y-4">
              ...
              <div>
                <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-2">Productos</p>
